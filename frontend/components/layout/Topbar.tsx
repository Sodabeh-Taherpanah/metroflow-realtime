  ...
  return (
    <header className="flex items-center justify-between border-b border-slate-200 bg-white/70 px-6 py-4 backdrop-blur lg:px-10 dark:border-slate-900 dark:bg-slate-950/80">
      <div className="flex items-center gap-4">
        <div className="hidden items-center gap-3 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm text-slate-500 md:flex dark:border-slate-800/60 dark:bg-slate-900/60 dark:text-slate-400">
          <Search className="h-4 w-4" />
          <span>Search stations, lines, or alerts</span>
        </div>
        <RealtimeIndicator />
      </div>
