...
exports.AppDataSource = new typeorm_1.DataSource({
    ...
    entities: [station_entity_1.Station, route_entity_1.Route, provider_entity_1.Provider, realtime_cache_entity_1.RealtimeCache, agent_trace_entity_1.AgentTrace],
    synchronize: false,
